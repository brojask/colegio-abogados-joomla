# $Id: joomla.sql $
# Translated by JoomlaSpanish.org  Febrero 2013 Joomla 2.5.10
# Codificación al guardar UTF-8 ¡ojo!

#
# Estructura de Tablas para la tabla `#__assets`
#
...
CREATE TABLE `#__categories` (
  ...
  `asset_id` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK para la tabla de #__assets.',
...
CREATE TABLE `#__content` (
  ...
  `asset_id` INTEGER UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK a la tabla de #__assets.',
...
(604, 'Español (Formal Internacional)', 'language', 'es-ES', '', 1, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(605, 'Español (Formal Internacional)', 'language', 'es-ES', '', 0, 1, 1, 0, '', '', '', '', 0, '0000-00-00 00:00:00', 0, 0);
...
INSERT INTO `#__menu_types` VALUES (1, 'mainmenu', 'Menú Principal', 'El menú principal del sitio');
...
) DEFAULT CHARSET=utf8 COMMENT='Actualizaciones disponibles';
...
) DEFAULT CHARSET=utf8 COMMENT='Actualizar Sitios';
...
) DEFAULT CHARSET=utf8 COMMENT = 'Enlaces de los sitios de extensiones para actualizar';
...
) DEFAULT CHARSET=utf8 COMMENT='Actualizar Categorías';
...
INSERT INTO `#__template_styles` VALUES (2, 'bluestork', '1', '1', 'Bluestork - Defecto', '{"useRoundedCorners":"1","showSiteName":"0"}');
INSERT INTO `#__template_styles` VALUES (3, 'atomic', '0', '0', 'Atomic - Defecto', '{}');
INSERT INTO `#__template_styles` VALUES (4, 'beez_20', 0, 1, 'Beez2 - Defecto', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/logo-js.png","sitetitle":"Joomla! Spanish","sitedescription":"Gestor de Contenido Open Source 2.5","navposition":"left","templatecolor":"personal","html5":"0"}');
...
CREATE TABLE IF NOT EXISTS `#__user_usergroup_map` (
  `user_id` integer unsigned NOT NULL default '0' COMMENT 'Clave externa a #__users.id',
  `group_id` integer unsigned NOT NULL default '0' COMMENT 'Clave externa a #__usergroups.id',
...
CREATE TABLE IF NOT EXISTS `#__usergroups` (
  `id` integer unsigned NOT NULL auto_increment COMMENT 'Clave primaria',
  `parent_id` integer unsigned NOT NULL default '0' COMMENT 'ID Lista de referencia adyacente',
  `lft` integer NOT NULL default '0' COMMENT 'Anidadas conjunto lft.',
  `rgt` integer NOT NULL default '0' COMMENT 'Anidadas conjunto rgt.',
  `title` varchar(100) NOT NULL default '',
  PRIMARY KEY  (`id`),
...
) DEFAULT CHARSET=utf8 COMMENT='Tabla para almacenar el perfil de usuario';
