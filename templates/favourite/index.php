...
$doc->addStyleSheet('templates/'.$this->template.'/css/k2style.css');
...
<head>
  ...
  <!-- Google Font -->
  <link href='http://fonts.googleapis.com/css?family=<?php echo $this->params->get('googleFont');?>' rel='stylesheet' type='text/css' />
  <link href='http://fonts.googleapis.com/css?family=<?php echo $this->params->get('textLogoGoogleFont');?>' rel='stylesheet' type='text/css' />
  ...
  <!--[if IE 7]>
      <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template;?>/css/bootstrap/font-awesome-ie7.min.css">
  <![endif]-->
</head>
...
<?php if ($this->countModules('advert')) { ?>
  <div class="container-fluid" id="fav-advertwrap">
    <div class="row-fluid">  
         <div id="fav-advert" class="span12 navigation">
  ...
  <div class="row-fluid">
    <?php if (($showBacktotop) !=0) : ?>
      <div id="fav-backtotop" class="span12">
        <a href="#bktop" title="BACK TO TOP"><img src="templates/<?php echo $this->template?>/images/backtotop.png" style="border:0;" alt="TOP" />
  ...
  <div class="row-fluid">
    <div id="fav-backtotop-mobile" class="span12">
          <a href="#bktop" title="BACK TO TOP">
            <img src="templates/<?php echo $this->template?>/images/backtotop.png" style="border:0;" alt="TOP" />
          </a>
      </div>
  </div>
</div>
        ...
        <div id="fav-copyright" class="clearfix">
          ...
          <?php if (($showCopyright) !=0) : ?>
            <div id="fav-showcopyright"
              class="<?php
              if ( $copyright == 2 ):echo ('span6');
              elseif ( $copyright == 3 ):echo ('span6');
              elseif ( $copyright == 4 ):echo ('span4');
              else: echo ('span12'); endif; ?>">
                <p>&#0169; <?php echo date('Y'); ?>
...
<div class="container-fluid">
  <div class="row-fluid">
    <?php if ($this->countModules('styles')) { ?>
         <div id="fav-styles">
           <jdoc:include type="modules" name="styles" style="icon" />
         </div>
    <?php } ?>
  </div>
</div>
