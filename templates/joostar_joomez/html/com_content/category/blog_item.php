...
<?php endif; ?>
	...
	<?php if ($params->get('show_category')) : ?>
			<dd class="category-name">
				...
				<?php if ($params->get('link_category')) : ?>
					<span class="category"><?php echo JText::sprintf($url); ?> | </span>
					<?php else : ?>
					<span class="category"><?php echo JText::sprintf($title); ?> | </span>
				<?php endif; ?>
			</dd>
	<?php endif; ?>
	...
	<?php if ($params->get('show_modify_date')) : ?>
			<dd class="modified">
			<?php echo JText::sprintf(JHTML::_('date',$this->item->modified, JText::_('DATE_FORMAT_LC3'))); ?>
			</dd>
	<?php endif; ?>
