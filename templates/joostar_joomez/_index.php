...
<div id="top">
<?php if($this->params->get('LogoType') == 'image') : ?><a  title="<?php $config = new JConfig(); echo $config->sitename; ?>" href="index.php"><img id="logo" src="<?php echo $tmpTools->templateurl(); ?>/images/<?php echo $tmpTools->colour ?>/logo.png" alt="<?php echo $this->params->get('logoText') ?>" /></a>
<?php else:?>
<h2 id="logo"><a href="index.php" title="<?php $config = new JConfig(); echo $config->sitename; ?>"><?php echo  $this->params->get( 'logoText1' );?> <span><?php echo  $this->params->get( 'logoText2' );?></span></a></h2><?php
endif; ?>
...
<?php if ($tmpTools->left()) { ?><div id="frontrightl"><jdoc:include type="modules" name="left" style="normal" /></div><?php } ?>
<?php if ($tmpTools->right()) { ?><div id="frontrightr"><jdoc:include type="modules" name="right" style="normal" /></div><?php } ?>
</div>
<?php } ?>
<?php if ($tmpTools->frontrightfull()) { ?>
<div id="frontrightfull"><jdoc:include type="modules" name="frontrightfull" style="normal" /></div>	 
<?php } ?>
<!-- frontpage end -->
<?php else : ?> 
<div id="header_wrap">
<?php if ($tmpTools->header=='menu') : 
	//echo $tmpTools->getHeaderText();
else : ?>
...
<div id="maincontent">
<jdoc:include type="message" />
<?php if ($tmpTools->left()) { ?><div id="left"><jdoc:include type="modules" name="left" style="normal" /></div><?php } ?>
<?php if ($tmpTools->right()) { ?><div id="right"><jdoc:include type="modules" name="right" style="normal" /></div><?php } ?>
...
<div id="footeright"><jdoc:include type="modules" name="footeright" style="socialmod" headerLevel="3" /></div>
<?php } ?>
<jdoc:include type="modules" name="footermenu" />
<p id="copyright"><a href="<?php echo $this->baseurl; ?>">Colegio de Abogados y Abogadas de Costa Rica</a>&middot Todos los derechos reservados &copy; <?php echo (date("Y")); ?></p>
</div>
